<?php
	...
	if(isset($_POST["them"])){
		...
		$sql = "INSERT INTO truyen(tentruyen, tacgia, anhminhhoa, idtheloai, trangthai) values('$tentruyen','$tacgia','$dich','$theloai','$trangthai')";
			mysql_query($sql);
		...
		if($tenanh!=""){
			...
			copy($_FILES["anhminhhoa"]["tmp_name"], $dich);
			$dich = substr($dich,9);
			$sql = "UPDATE truyen SET tentruyen='$tentruyen', tacgia = '$tacgia', anhminhhoa='$dich', idtheloai='$theloai', trangthai='$trangthai' WHERE idtruyen='$id'";
			// Xóa ảnh cũ
			...
			$sql = "UPDATE truyen SET tentruyen='$tentruyen', tacgia = '$tacgia', idtheloai='$theloai', trangthai='$trangthai' WHERE idtruyen='$id'";
