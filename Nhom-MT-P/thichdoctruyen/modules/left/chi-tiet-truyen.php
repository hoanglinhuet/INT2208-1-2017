        ...
        <div class="panel-body">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <button class="btn btn-default" type="submit">Yêu thích</button>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Chương mới</th>
                        ...
                        <tbody>
                        <?php
							$sql1 = "SELECT * FROM chuong WHERE idtruyen = '$idtruyen' ORDER BY idchuong DESC LIMIT 2";
							$chuong1 = mysql_query($sql1);
							while($dong1 = mysql_fetch_array($chuong1)){
						?>
                            <tr>
                                <td width="80%">
                                    <a href="index.php?xem=chuong&idtheloai=<?php echo $dong["idtheloai"]?>&idtruyen=<?php echo $dong1["idtruyen"]?>&idchuong=<?php echo $dong1["idchuong"]?>">
										<?php echo $dong1["tenchuong"]?>
                                    </a>
                                </td>
                                <td>2 giờ trước</td>
                            </tr>
...
<div class="row">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Tóm tắt truyện</h3>
        </div>
        <div class="panel-body">
            <p>
